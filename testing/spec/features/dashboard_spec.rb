...
describe "dashboard check", :type => :feature do
  before :each do 
  ...
  it "should have 10 complaints" do
    visit complaints_path
    
    expect(page).to have_selector('tr', :count => 10)
  end

  it "should have 5 same emails" do 
    visit complaints_path

    expect(page).to have_selector('td', text: 'andrew.rebinson@gmail.com', count: 5)
  end
end
