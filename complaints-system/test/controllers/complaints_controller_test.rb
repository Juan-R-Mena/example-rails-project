...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { content: @complaint.content, user_email: @complaint.user_email } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { content: @complaint.content, user_email: @complaint.user_email } }
